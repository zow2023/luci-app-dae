...
return view.extend({
    load: function () {
        return utils.ensureAllConfigs().then(function () {
            return fs.read('/etc/dae/config.d/route.dae');
        });
    },
    ...
    render: function (configData) {
        ...
        m = new form.Map('dae', _('Routing Settings'), _('Configure routing rules for DAE.'));
        ...
        o = s.option(form.TextValue, 'routeconf', _('Route Configuration'), _('Configure routing rules for DAE. Click "Save" to apply changes to /etc/dae/config.d/route.dae.'));
        o.rows = 25;
        o.rmempty = true;
        o.monospace = true;
        ...
        o.write = function (section_id, formvalue) {
            return utils.ensureAllConfigs().then(function () {
                return fs.write('/etc/dae/config.d/route.dae', formvalue.replace(/\r\n/g, '\n'));
            });
        };
